...
// 		.AddAnimation('fadeIn', 'fade', true, 'default', 1)
// 		.AddAnimation('fadeOut', 'fade', true, 'default', 0);
...
// 		.AddAnimation('moveRight', 'move', false, 'move', 5)
// 		.AddAnimation('moveLeft', 'move', false, 'move', -5)
// 		.AddAnimation('fadeIn', 'fade', true, 'alpha', 1)
// 		.AddAnimation('fadeOut', 'fade', true, 'alpha', 0);
