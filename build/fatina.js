// [Fatina]  Build: 3.0.0-beta.2 - Saturday, April 6th, 2019, 2:41:23 PM  
...
var BezierType;
(function (BezierType) {
    BezierType["Cubic"] = "cubic";
    BezierType["Quadratic"] = "quadratic";
    BezierType["Catmull"] = "catmull";
})(BezierType = exports.BezierType || (exports.BezierType = {}));
var PathType;
(function (PathType) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const interpolation_1 = __webpack_require__(/*! ./advanced/interpolation */ "./src/advanced/interpolation.ts");
...
class Fatina {
    constructor() {
         ...
         * @returns {ITween}
         */
        this.curve = (obj, settings) => interpolation_1.curve(this, obj, settings);
        /**
         * Arc Curve Animation
         *
         * @exports
         ...
         * @returns {ITween}
         */
        this.arc = (obj, settings) => interpolation_1.arc(this, obj, settings);
        /**
         * Path Animation
         *
         * @exports
         ...
         * @returns {ISequence}
         */
        this.path = (obj, settings) => interpolation_1.path(this, obj, settings);
    }
    get elapsed() {
