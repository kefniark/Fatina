// [Fatina]  Build: 3.0.0-beta.3 - Saturday, April 6th, 2019, 5:44:05 PM  
 (function(){'use strict';(function(c,d){"object"===typeof exports&&"object"===typeof module?module.exports=d():"function"===typeof define&&define.amd?define("[customInterpolateName]",[],d):"object"===typeof exports?exports["[customInterpolateName]"]=d():c["[customInterpolateName]"]=d()})("undefined"!==typeof self?self:this,function(){return function(c){function d(f){if(e[f])return e[f].exports;var b=e[f]={i:f,l:!1,exports:{}};c[f].call(b.exports,b,b.exports,d);b.l=!0;return b.exports}var e={};d.m=c;d.c=e;d.d=
function(c,b,g){d.o(c,b)||Object.defineProperty(c,b,{enumerable:!0,get:g})};d.r=function(c){"undefined"!==typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(c,Symbol.toStringTag,{value:"Module"});Object.defineProperty(c,"__esModule",{value:!0})};d.t=function(c,b){b&1&&(c=d(c));if(b&8||b&4&&"object"===typeof c&&c&&c.__esModule)return c;var g=Object.create(null);d.r(g);Object.defineProperty(g,"default",{enumerable:!0,value:c});if(b&2&&"string"!=typeof c)for(var a in c)d.d(g,a,function(a){return c[a]}.bind(null,
a));return g};d.n=function(c){var b=c&&c.__esModule?function(){return c["default"]}:function(){return c};d.d(b,"a",b);return b};d.o=function(c,b){return Object.prototype.hasOwnProperty.call(c,b)};d.p="";return d(d.s=5)}([function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});class f{constructor(){this.events={};this.duration=this.elapsed=0;this.timescale=1;this.state=0;this.first=!0}get isIdle(){return 0===this.state}get isRunning(){return 1===this.state}get isFinished(){return 3<=this.state}get isPaused(){return 2===
this.state}start(){if(0!==this.state)return this;this.first?this.validate():this.check();this.state=1;this.parent.addTick(this.tickCb);this.first&&(this.emitEvent(this.events.start),this.first=!1);return this}reset(b){this.state=0;b||this.removeParent();this.loop&&(this.loop.value=this.loop.original);this.loopInit();this.emitEvent(this.events.restart)}resetAndStart(b){this.loopInit();this.emitEvent(this.events.restart);this.state=1;0<b&&this.tickCb(b)}setParent(b){this.removeParent();this.parent=
b;return this}setTimescale(b){this.timescale=b;return this}pause(){1!==this.state?this.info(1,"Cannot pause this tween ",this.state):(this.state=2,this.removeParent())}resume(){2!==this.state?this.info(1,"Cannot resume this tween ",this.state):(this.state=1,this.parent.addTick(this.tickCb))}skip(b){3<=this.state?this.info(1,"Cannot skip this tween ",this.state):(0===this.state&&this.emitEvent(this.events.start),b?this.tickCb(this.duration-this.elapsed+(this.yo?this.yo.value*this.duration:0)):(this.elapsed=
this.duration,this.complete()))}kill(){4===this.state?this.info(1,"Cannot kill this tween ",this.state):(this.state=4,this.removeParent(),this.emitEvent(this.events.kill))}setLoop(b){this.loop||(this.loop={original:1,value:1});this.loop.original=Math.round(b);this.loop.value=this.loop.original;return this}setSettings(b){this.settings?Object.assign(this.settings,b):this.settings=b;return this}complete(){3<=this.state?this.info(1,"Cannot complete this tween ",this.state):(this.state=3,this.removeParent(),
this.emitEvent(this.events.complete))}removeParent(){this.parent&&this.parent.removeTick(this.tickCb)}check(){}validate(){}loopInit(){this.elapsed=0}info(b,c,a){!this.settings||b>this.settings.logLevel||console.log(c,a)}emit(b,c){if(this.settings&&!this.settings.safe)return b.apply(this,c);try{b.apply(this,c)}catch(a){console.warn(a)}}emitEvent(b,c){if(b)if(b instanceof Array)for(const a of b)this.emit(a,c);else this.emit(b,c)}onStart(b){return this.onEvent("start",b)}onRestart(b){return this.onEvent("restart",
b)}onUpdate(b){return this.onEvent("update",b)}onKilled(b){return this.onEvent("kill",b)}onComplete(b){return this.onEvent("complete",b)}onEvent(b,c){this.events[b]?this.events[b]instanceof Array?this.events[b].push(c):this.events[b]=[this.events[b],c]:this.events[b]=c;return this}}d.BaseTween=f},function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});const f=Math.PI,b=Math.PI/2,g={linear:a=>a,inQuad:a=>a*a,outQuad:a=>2*a-a*a,inOutQuad:a=>.5>a?2*a*a:2*(2*a-a*a)-1,inCubic:a=>a*a*a,outCubic:a=>
3*a-3*a*a+a*a*a,inOutCubic:a=>.5>a?4*a*a*a:4*(3*a-3*a*a+a*a*a)-3,inQuart:a=>a*a*a*a,outQuart:a=>{const b=a*a;return 4*a-6*b+4*b*a-b*b},inOutQuart:a=>{if(.5>a)return 8*a*a*a*a;{const b=a*a;return 8*(4*a-6*b+4*b*a-b*b)-7}},inSine:a=>1===a?1:1-Math.cos(b*a),outSine:a=>Math.sin(b*a),inOutSine:a=>.5>a?(1-Math.cos(f*a))/2:(1+Math.sin(f*(a-.5)))/2,inCirc:a=>1-Math.sqrt(1-Math.pow(a,2)),outCirc:a=>Math.sqrt(1-Math.pow(1-a,2)),inOutCirc:a=>.5>a?(1-Math.sqrt(1-4*a*a))/2:(1+Math.sqrt(-3+8*a-4*a*a))/2,inQuint:a=>
a*a*a*a*a,outQuint:a=>--a*a*a*a*a+1,inOutQuint:a=>{a*=2;return 1>a?.5*a*a*a*a*a:.5*((a-=2)*a*a*a*a+2)},inExponential:a=>1===a?1:0===a?0:Math.pow(1024,a-1),outExponential:a=>1===a?1:1-Math.pow(2,-10*a),inOutExponential:a=>{if(0===a)return 0;if(1===a)return 1;a*=2;return 1>a?.5*Math.pow(1024,a-1):.5*(-Math.pow(2,-10*(a-1))+2)},inElastic:a=>0===a?0:-Math.pow(2,10*(a-1))*Math.sin(5*(a-1.1)*Math.PI),outElastic:a=>1===a?1:Math.pow(2,-10*a)*Math.sin(5*(a-.1)*Math.PI)+1,inOutElastic:a=>{if(0===a)return 0;
if(1===a)return 1;a*=2;return 1>a?-.5*Math.pow(2,10*(a-1))*Math.sin(5*(a-1.1)*Math.PI):.5*Math.pow(2,-10*(a-1))*Math.sin(5*(a-1.1)*Math.PI)+1},inBack:a=>1===a?1:a*a*(2.70158*a-1.70158),outBack:a=>0===a?0:--a*a*(2.70158*a+1.70158)+1,inOutBack:a=>{a*=2;return 1>a?.5*a*a*(3.5949095*a-2.5949095):.5*((a-=2)*a*(3.5949095*a+2.5949095)+2)},outBounce:a=>a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375,inBounce:a=>1-g.outBounce(1-
a),inOutBounce:a=>.5>a?.5*g.inBounce(2*a):.5*g.outBounce(2*a-1)+.5};d.easeNames=g},,function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});c=e(0);class f extends c.BaseTween{constructor(b){super();this.remains=0;this.duration=b;this.tickCb=this.tick.bind(this)}tick(b){for(this.remains=b*this.timescale;0<this.remains;){this.elapsed+=this.remains;b=Math.max(Math.min(this.elapsed/this.duration,1),0);this.events.update&&this.emitEvent(this.events.update,[this.remains,b]);if(this.elapsed<this.duration)break;
this.remains=this.elapsed-this.duration;if(this.loop&&(this.loop.value--,0!==this.loop.value)){this.resetAndStart(0);continue}this.complete();break}}}d.Delay=f},function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});c=e(0);const f=e(8),b=e(3);class g extends c.BaseTween{constructor(a){super();this.evtTick=new Set;this.tweens=[];this.remains=this.index=0;this.tickCb=this.tick.bind(this);if(a){this.tweens=Array(a.length);for(let b=0;b<a.length;b++)a[b].setParent(this),this.tweens[b]=[a[b]]}}get count(){return this.tweens.length}loopInit(){this.index=
0;for(const a of this.tweens)for(const b of a)b.reset()}addTick(a){this.evtTick.add(a)}removeTick(a){this.evtTick.delete(a)}tick(a){3<=this.state||(this.remains=a*this.timescale,this.elapsed+=this.remains,this.localTick(this.remains))}localTick(a,b){this.cur||this.nextTween();this.cur&&(this.evtTick.forEach(function(b){b(a)}),!0!==b&&this.events.update&&this.emitEvent(this.events.update,[a,0]));this.remains=a;if(this.cur){for(const a of this.cur)if(3!==a.state)return;this.remains=this.cur[0].elapsed-
this.cur[0].duration;this.events.stepEnd&&this.emitEvent(this.events.stepEnd,this.cur[0]);this.cur=void 0;this.index++;if(.01<this.remains){this.localTick(this.remains,!0);return}}if(!this.cur&&this.tweens.length===this.index){if(this.loop&&(this.loop.value--,0!==this.loop.value)){this.resetAndStart(this.remains);return}this.complete()}}nextTween(){if(this.cur=this.tweens[this.index]){for(const a of this.cur)a.start();this.events.stepStart&&this.emitEvent(this.events.stepStart,this.cur[0])}}append(a){a.setParent(this);
this.tweens[this.tweens.length]=[a];return this}appendCallback(a){a=new f.Callback(a);a.setParent(this);this.tweens[this.tweens.length]=[a];return this}appendInterval(a){a=new b.Delay(a);a.setParent(this);this.tweens[this.tweens.length]=[a];return this}prepend(a){a.setParent(this);this.tweens.unshift([a]);return this}prependCallback(a){a=new f.Callback(a);a.setParent(this);this.tweens.unshift([a]);return this}prependInterval(a){a=new b.Delay(a);a.setParent(this);this.tweens.unshift([a]);return this}skip(a){if(3<=
this.state)this.info(1,"Cannot skip this tween ",this.state);else{for(const b of this.tweens)for(const c of b)0===c.elapsed&&this.emitEvent(this.events.stepStart,c),c.skip(a),this.emitEvent(this.events.stepEnd,c);super.skip()}}kill(){if(4===this.state)this.info(1,"Cannot kill this tween ",this.state);else{for(const a of this.tweens)for(const b of a)b.kill();super.kill()}}join(a){if(0===this.tweens.length)return this.append(a);a.setParent(this);this.tweens[this.tweens.length-1].push(a);return this}onStepStart(a){return this.onEvent("stepStart",
a)}onStepEnd(a){return this.onEvent("stepEnd",a)}}d.Sequence=g},function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});c=e(6);e=e(10);d.EasingType=e.EasingType;d.default=new c.Fatina},function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});const f=e(7),b=e(3),g=e(4),a=e(9);let h,k,l;"undefined"!==typeof window&&(k=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame,l=window.cancelAnimationFrame||window.mozCancelAnimationFrame);
class m{constructor(){this.plugin={};this.loadedPlugins=[];this.eventCreated=[];this.settings={logLevel:0,safe:!0,smooth:!1,maxFrameDt:50,maxFrameNumber:40,maxDt:500};this.version="3.0.0-beta.3";this.lastTime=this.dt=this.time=0;this.initialized=!1}get elapsed(){return this.manager.elapsed}get mainTicker(){this.initialized||this.init();return this.manager}init(a){if(this.initialized)return!1;this.manager||(this.manager=new f.Ticker,this.manager.start());"undefined"===typeof window||a||(h=
k(this.updateLoop.bind(this)));console.log(" %c Fatina - Tweening library for games ("+this.version+") https://github.com/kefniark/Fatina ","background: #222; color: #9fbff4; padding: 5px");return this.initialized=!0}setTimescale(a){this.init();this.manager.setTimescale(a)}pause(){this.init();this.manager.pause()}resume(){this.init();this.manager.resume()}destroy(){this.manager&&this.manager.kill();h&&l(h);this.initialized=!1}update(a){this.initialized&&this.manager&&(this.manager.tick(a),this.time+=
a)}tween(b){b=new a.Tween(b);this.addContext(b);return b}sequence(a){a=new g.Sequence(a);this.addContext(a);return a}delay(a){a=new b.Delay(a);this.addContext(a);return a}setTimeout(a,c){a=(new b.Delay(c)).onComplete(a);this.addContext(a);return a.start()}setInterval(a,c){a=(new b.Delay(c)).onRestart(a).setLoop(-1);this.addContext(a);return a.start()}addContext(a){this.initialized||this.init();a.setParent(this.manager);0===this.settings.logLevel&&this.settings.safe||a.setSettings(this.settings);this.emitCreated(a)}ticker(){this.initialized||
this.init();const a=new f.Ticker,b=a.tick.bind(a);a.setParent(this.manager,b);this.manager.addTick(b);a.start();this.emitCreated(a);return a}updateLoop(a){this.dt+=a-this.lastTime;this.dt>this.settings.maxDt/2&&0===this.lastTime?this.dt=0:this.dt>this.settings.maxDt&&(console.warn(`dt too high ${Math.round(this.dt)}ms. , Capped to ${this.settings.maxDt}ms.`),this.dt=this.settings.maxDt);if(this.settings.smooth){let a=0;for(;0<this.dt&&a<this.settings.maxFrameNumber;){const b=Math.min(this.dt,this.settings.maxFrameDt);
this.update(b);this.dt-=b;a++}}else this.update(this.dt),this.dt=0;this.lastTime=a;h=k(this.updateLoop.bind(this))}loadPlugin(a){a.init(this);this.loadedPlugins.push(a);console.log(" %c Fatina - Loaded Plugin "+a.name,"background: #222; color: #9fbff4; padding: 5px");this.info(2,"Plugin Loaded",a.name)}info(a,b,c){a>this.settings.logLevel||(c?console.log(b,c):console.log(b))}emit(a,b){if(!this.settings.safe)return a(b);try{a(b)}catch(n){console.warn(n)}}emitCreated(a){for(const b of this.eventCreated)this.emit(b,
a)}addListenerCreated(a){this.eventCreated.push(a)}removeListenerCreated(a){a=this.eventCreated.indexOf(a);-1!==a&&this.eventCreated.splice(a,1)}setLog(a){this.settings.logLevel=a}setSafe(a){this.settings.safe=a}}d.Fatina=m},function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});class f{constructor(){this.state=0;this.timescale=1;this.duration=this.elapsed=0;this.ticks=new Set;this.newTicks=new Set;this.dt=0}setParent(b,c){this.tickCb=c;this.parent=b}setTimescale(b){this.timescale=b}addTick(b){this.newTicks.add(b)}removeTick(b){this.ticks.delete(b)||
this.newTicks.delete(b)}tick(b){1===this.state&&(this.dt=b*this.timescale,0<this.newTicks.size&&(this.newTicks.forEach(b=>this.ticks.add(b)),this.newTicks.clear()),this.ticks.forEach(b=>b(this.dt)),this.elapsed+=this.dt)}start(){0===this.state&&(this.state=1)}pause(){1===this.state&&(this.state=2)}resume(){2===this.state&&(this.state=1)}kill(){3<=this.state||(this.parent&&this.tickCb&&this.parent.removeTick(this.tickCb),this.state=4)}skip(){}reset(){this.state=0}get isIdle(){return 0===this.state}get isRunning(){return 1===
this.state}get isFinished(){return 3<=this.state}get isPaused(){return 2===this.state}}d.Ticker=f},function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});c=e(0);class f extends c.BaseTween{constructor(b){super();this.callback=b;this.tickCb=this.tick.bind(this)}tick(b){this.elapsed+=b;this.duration=0;this.callback();this.emitEvent(this.events.update,[b,1]);this.complete()}}d.Callback=f},function(c,d,e){Object.defineProperty(d,"__esModule",{value:!0});const f=e(1);c=e(0);const b=e(4);class g extends c.BaseTween{constructor(a){super();
